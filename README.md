...
대학정보포털 **어디가(adiga.kr)** 의 공식 전형결과 데이터를 바탕으로, 서울대 수능 환산식, 과탐Ⅱ 가산점(+3점/+5점), 교과평가(A.A~C.C) 정밀 계산 및 6개년(2021~2026학년도) 입결 변동 궤적을 직관적인 데이터 시각화로 제공합니다.
...
1. **📊 자연계 6개년 입결 트렌드 분석 & 붉은선 자동 감지**
   - 2021~2026학년도 39개 학과의 70% Cut 순위 변동 궤적을 반응형 SVG 범프 차트로 시각화
...
| **Data Engine** | 2021~2026 어디가(adiga.kr) 공식 70% Cut 데이터셋 & 서울대 정시 환산식 알고리즘 |
